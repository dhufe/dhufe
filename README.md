...
- [ansible/galaxy](https://github.com/ansible/galaxy) - Request namespace: hufschlaeger (1 day ago)
...
- [usememos/memos](https://github.com/usememos/memos) - An open-source, self-hosted alternative to cloud note-taking services. No tracking, no ads, no subscription fees — just a clean, fast way to capture and organize your ideas. (5 days ago)
